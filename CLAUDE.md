...
Project ini sudah melewati fase "Jali nulis chapter → Claude baca → Claude kasih feedback."
...
3. **Continuity keeper** — track konsistensi antara runtime constraints dan canon novel
4. **Cermin** — kasih tahu Jali apa yang sebenarnya sedang dibangun (seperti dulu kasih tahu apa yang sebenarnya ditulis)
5. **Bukan editor gaya** — jangan ubah suara. Jali punya tone sendiri. Tugas memperjelas, bukan menghaluskan paksa.
